...
const homeGallery = [
  {
    ...
    alt: "Clinical allergy assessment at ENT Care Clinic in Greater Kailash-1, Delhi",
    caption: "Allergy assessment at the clinic",
    width: 640,
    height: 640,
  },
  {
    src: earSurgery,
    alt: "Endoscopic ear surgery instruments prepared in an operating theatre",
    caption: "Endoscopic ear surgery",
    width: 1280,
    height: 860,
  },
  {
    ...
    caption: "Functional endoscopic sinus surgery (FESS)",
    width: 1200,
    height: 675,
  },
  {
    src: award,
    alt: "Dr. Aashima Chopra receiving professional recognition in ENT",
        ...
        <div className="shell grid items-center gap-10 py-12 md:py-20 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="animate-rise">
            ...
            <h1 className="mt-4 font-display text-3xl leading-[1.1] font-semibold sm:text-4xl lg:text-5xl">
              {site.doctor}
              <span className="mt-3 block text-base font-medium text-teal sm:text-lg">
                {site.credentials}
              </span>
            </h1>
            ...
            <p className="mt-6 max-w-xl text-sm leading-relaxed text-navy-foreground/75 md:text-base">
              Providing advanced and compassionate care for ear, nose and throat conditions, with a
              special focus on endoscopic ear surgery, endoscopic sinus surgery and minimally
          ...
          <div className="relative mx-auto w-full max-w-sm lg:max-w-none">
            <div
              className="absolute inset-x-6 top-6 bottom-0 rounded-[2.5rem] bg-teal/15 blur-2xl"
              aria-hidden
            />
            <img
        ...
        <div className="shell grid items-center gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-muted-foreground">
              Dr. Aashima Chopra's practice combines careful diagnosis, empathy and compassionate
              communication with minimally invasive surgical technique. Each consultation starts
              with a thorough examination — endoscopic where needed — so that the plan you leave
              with is based on what is actually causing your symptoms.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              Medical management is offered first wherever it is appropriate. When surgery is the
              right step, the approach, expected recovery and alternatives are discussed in plain
              language.
            </p>
            <Link
              to="/about"
      ...
      <section className="section bg-mist">
        <div className="shell">
          <SectionHeading
            ...
            title="A closer look at our care"
            intro="Explore the clinic, specialist procedures and professional journey of Dr. Aashima Chopra."
          />
          <div className="mt-10 grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-4">
            {homeGallery.map((image) => (
              <figure
                key={image.caption}
                className="group overflow-hidden rounded-2xl border border-border bg-card shadow-card sm:rounded-3xl"
              >
                <img
                  src={image.src}
                  alt={image.alt}
                ...
                />
                <figcaption className="px-3 py-3 text-xs leading-relaxed text-muted-foreground sm:px-4 sm:text-sm">
                  {image.caption}
                </figcaption>
              </figure>
            ))}
          ...
          <div className="mt-8">
            <Link
              to="/gallery"
              className="inline-flex rounded-full bg-navy px-6 py-3 text-xs font-semibold tracking-[0.1em] text-navy-foreground uppercase transition-transform hover:-translate-y-0.5"
            >
              View Full Gallery
            </Link>
          </div>
        ...
        <div className="shell">
          ...
          <div className="mt-8 text-center">
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="inline-flex items-center gap-2 rounded-full bg-navy px-6 py-3 text-xs font-semibold tracking-[0.1em] text-navy-foreground uppercase"
            >
