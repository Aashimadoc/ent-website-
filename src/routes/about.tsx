...
const highlights = [
  { icon: GraduationCap, title: "MBBS, DNB (ENT)", body: "Postgraduate specialist training in otorhinolaryngology." },
  ...
  { icon: Microscope, title: "Endoscopic Focus", body: "Special interest in endoscopic ear and sinus surgery." },
];
      ...
      <section className="section">
        <div className="shell grid items-start gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          <img
            ...
            fetchPriority="high"
            decoding="async"
            className="aspect-square w-full rounded-[2rem] object-cover shadow-float"
          />
          <div>
            <SectionHeading eyebrow="Profile" title="Advanced ENT care, explained in plain language" />
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground md:text-base">
              <p>
                Dr. Aashima Chopra is an ear, nose and throat specialist practising in New Delhi. Her clinical work
                covers the full range of routine ENT problems in adults and children, alongside a focused surgical
                practice in endoscopic ear surgery and endoscopic sinus surgery. She places particular importance on
                empathy, compassion and making patients feel heard before deciding on treatment.
              </p>
              <p>
                She completed her DNB in ENT as a Gold Medallist and is a Member of the National Academy of Medical
                Sciences. Her approach to endoscopic surgery is driven by the same principle that guides her clinic
                work: use the least invasive approach that reliably treats the problem.
              </p>
              <p>
                Patients are seen for consultations at the clinic in {site.locality}, where diagnostic ear and nasal
                endoscopy can be performed during the same visit when required.
              </p>
            </div>
            ...
            <ol className="mt-8 space-y-5">
              {philosophy.map((p, i) => (
                <li key={p} className="flex gap-4">
                  ...
                  <p className="pt-1.5 text-sm leading-relaxed text-muted-foreground md:text-base">{p}</p>
                </li>
              ))}
            </ol>
          </div>
